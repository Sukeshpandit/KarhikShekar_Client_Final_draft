...
export const StatCard = styled(motion.div)(({ theme }) => ({
  ...
  '&:hover': {
    ...
    boxShadow: '0 16px 48px rgba(0,0,0,0.5), 0 0 24px rgba(212,175,55,0.1)',
    '&::before': { opacity: 1 },
    '&::after': { opacity: 1 },
  },
  [theme.breakpoints.up('sm')]: {
...
export const StatIconWrapper = styled(Box)(({ theme }) => ({
  ...
  '& .MuiSvgIcon-root': { fontSize: '18px', color: '#fff', position: 'relative', zIndex: 1 },
  [theme.breakpoints.up('sm')]: {
    width: '58px',
    height: '58px',
    borderRadius: '15px',
...
export const StatLabel = styled(Box)(({ theme }) => ({
  ...
  lineHeight: 1.5,
  [theme.breakpoints.up('sm')]: { fontSize: '0.72rem' },
}));
